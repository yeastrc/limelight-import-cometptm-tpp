...
package org.yeastrc.limelight.xml.cometptm_tpp.reader;
...
import org.yeastrc.limelight.xml.cometptm_tpp.objects.TPPReportedPeptide;
import org.yeastrc.limelight.xml.cometptm_tpp.objects.TPPResults;
import org.yeastrc.limelight.xml.cometptm_tpp.utils.ReportedPeptideUtils;
import org.yeastrc.limelight.xml.cometptm_tpp.utils.TPPParsingUtils;
...
public class TPPResultsParser {
	...
	public static TPPResults getTPPResults(File pepXMLFile, CometPTMParameters params ) throws Throwable {
		...
		results.setMsFraggerVersion( TPPParsingUtils.getCometVersionFromXML( msAnalysis ) );
