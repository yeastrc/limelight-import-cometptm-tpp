...
public class MatchedProteinsBuilder {
	...
	private Collection<PeptideObject> getNakedPeptideObjectsForReportedPeptides( Collection<TPPReportedPeptide> cometPeptides ) {

		Collection<PeptideObject> nakedPeptideObjects = new HashSet<>();

		for( TPPReportedPeptide reportedPeptide : cometPeptides ) {
